...
class _EditFormState extends State<EditForm> {
  ...
  void handlePost(
    ...
    if (userAuthState.getCurrentUser.uid != null) {
      bool isSuccess = await FirestoreServices().updateProject(project: {
  ...
  Widget build(BuildContext context) {
    String docId = widget.project["docId"];
    _projectTitleController.text = widget.project["projectTitle"];
    _projectTypeController.text = widget.project["projectType"];
    _projectDescController.text = widget.project["projectDesc"];
    _optLinkNameController.text = widget.project["optLinkName"];
    _optLinkController.text = widget.project["optLink"];
    return isLoading
        ? Container(
            child: Loading(),
